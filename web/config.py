...
CONFIG = {
    ...
    "attn_type":   {"type":"choice","options":["1head","mha","gqa"],"default":"1head","label":"Attention Type","group":"Architecture"},
    "n_heads":     {"type":"int","default":1,"min":1,"max":64,"label":"Number of Heads","group":"Architecture","show_if":{"attn_type":["mha","gqa"]}},
    "n_kv":        {"type":"int","default":1,"min":1,"max":64,"label":"KV Heads (GQA)","group":"Architecture","show_if":{"attn_type":"gqa"}},
    "pos_type":    {"type":"choice","options":["wpe","rope"],"default":"wpe","label":"Position Encoding","group":"Architecture"},
